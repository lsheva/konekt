...
This is the smallest amount of code to a working connection, and also the smallest download: this stack first-loads **19.06 kB** in a production Vite app, where AppKit first-loads **721.26 kB**. You do not need to care about that yet—it simply means there is no penalty for starting the easy way.
