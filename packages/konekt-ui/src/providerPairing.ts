...
/** The part of a konekt `Provider` the modal drives. A `Provider` satisfies it as it is. */
...
/** Pairing straight from a provider: no connectors, no wagmi, every namespace the provider proposes. */
